...
public class CommissionEmployee extends Employee {
    ...
    public CommissionEmployee(String name, String noKTP, double sales, double rate, int tanggal, int bulan, int tahun){ //tambahkan int tanggal, int bulan, int tahun //jawaban no 4
