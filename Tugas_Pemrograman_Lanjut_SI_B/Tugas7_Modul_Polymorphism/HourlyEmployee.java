...
public class HourlyEmployee extends Employee {
    ...
    public HourlyEmployee(String name, String noKTP, double hourlyWage, double hoursWorked, int tanggal, int bulan, int tahun) { //tambahkan int tanggal, int bulan, int tahun //jawaban no 4
