...
public class BasePlusCommissionEmployee extends CommissionEmployee {
    ...
    public  BasePlusCommissionEmployee(String  name,  String noKTP, double sales, double rate, double salary, int tanggal, int bulan, int tahun) { //tambahkan int tanggal, int bulan, int tahun //jawaban no 4
