...
public class TestVehicle1 {
    public static void main(String[] args){
        ...
        System.out.println("Add load(100kg) : " + (vehicle.load=500)); //jawaban no 2  dan no 3, awalanya error karena tipe variabel load private
        ...
        //System.out.println("Add load(100kg) : " + (vehicle.load=500)); //jawaban no 3
