...
class Perpus {
    ...
    public Perpus(String kategori1, String penulis1, String judul1, String bahasa1, String penerbitan1, String edisi1, String halaman1, String sinopsis1){
...
public class javaPerpus {
    public static void main(String[] args) {
        ...
        b11.setEdisi("-");
        b11.setHalaman(42);
        b11.setSinopsis("Buku ini menceritakan tentang rasa nasionalisme bangsa Indonesia sejak zaman kemerdekaan hingga saat ini");
        b11.displayMessage();
        System.out.println("=====================================");
        ...
        b13.setEdisi("-");
        b13.setHalaman(390);
        b13.setSinopsis("Buku ini menceritakan terkait perilaku kekejaman dan kebengisan yang dirasakan oleh kelompok aktivis mahasiswa di masa Orde Baru.");
        b13.displayMessage();
        System.out.println("=====================================");
